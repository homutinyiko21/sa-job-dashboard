https://sa-job-dashboard-reevwxaodep25sqzdwxikp.streamlit.app/
...
- Interactive charts
- Real-time style data refresh workflow
...
- `jobs.csv` → Dataset  
- `scraper.py` → Data update pipeline  
